...
export function FieldPanelOverlay({ fieldType }: { fieldType: FieldType }) {
  return (
    <button className="bg-card flex cursor-grab items-center gap-2 rounded border px-6 py-2.5 font-semibold capitalize shadow-lg dark:shadow-lg/40 [&>svg]:size-5">
