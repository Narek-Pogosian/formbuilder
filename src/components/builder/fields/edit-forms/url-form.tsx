...
import { urlSchema } from "@/lib/schemas/form-schemas";
...
export default function UrlEditForm({ field }: EditFormProps) {
  if (field.type !== "url")
  ...
  const { onSubmit, firstInputRef } = useEditForm<UrlFormSchemaType>(field);
