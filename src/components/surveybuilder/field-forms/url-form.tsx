...
import { urlSchema } from "@/lib/zod/survey-schemas";
...
const urlFormSchema = urlSchema.omit({ id: true, type: true });
type UrlFormSchemaType = z.infer<typeof urlFormSchema>;

function UrlForm({ defaultField, handleAdd }: FieldFormProps) {
